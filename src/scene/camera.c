...
float *
THE_CameraStaticViewProjection(float *out_m4, THE_Camera *cam)
{
...
float *
THE_CameraPosition(float *out_v3, THE_Camera *cam)
{
	float inv[16];
...
float *
THE_CameraForward(float *out_v3, THE_Camera *cam)
{
...
void
THE_CameraMovementSystem(THE_Camera *cam, float deltatime)
{
	float eye[3];
