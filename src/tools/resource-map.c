...
void
THE_ResourceMapAddMeshFromPath(
  THE_ResourceMap *rm, const char *name, const char *path)
{
...
void
THE_ResourceMapAddMesh(THE_ResourceMap *rm, const char *name, THE_Mesh mesh)
{
	THE_HMapInsert(rm->meshes, name, &mesh);
}

THE_Mesh
THE_ResourceMapGetMesh(THE_ResourceMap *rm, const char *name)
{
...
void
THE_ResourceMapAddTextureFromPath(THE_ResourceMap *rm, const char *name,
  const char *path, enum THE_TexType type)
{
	THE_ASSERT(
...
THE_Texture
THE_ResourceMapGetTexture(THE_ResourceMap *rm, const char *name)
{
